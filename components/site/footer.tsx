...
export function Footer(){
  return <footer className="bg-luxury-navy text-white">
    <div className="container grid gap-10 py-16 md:grid-cols-4">
      ...
      <div><h3 className="font-bold">Contact</h3><div className="mt-4 grid gap-3 text-white/70"><p className="flex gap-2"><Phone size={18}/> +254 710 557164</p><p className="flex gap-2"><Mail size={18}/> info@feronetours.com</p><p className="flex gap-2"><MapPin size={18}/> Nairobi, Kenya</p></div></div>
    </div>
